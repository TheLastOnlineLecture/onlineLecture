		...
		<main>
			<div class="center">
				<div class="teacherDetailImg" style="background-color:#ECF7FD">
					<div class="center">
						<img src="/public/teacher_society/society_cha.jpg" alt="" />
						<div class="teacherInfo">
							<!-- 선생님 이름 동적으로 변경 -->
							<div class="teacherName">${teacherInfo.userName} 선생님</div>
							<p class="teacherProfile">약력</p>
							<p>
							    서울대학교 대학원 윤리교육과 석사<br />
							    現) 청솔학원 생활과 윤리, 윤리와 사상 강사<br />
							    現) 이투스기숙학원 생활과 윤리, 윤리와 사상 강사<br />
							    現) 강남하이퍼학원 생활과 윤리, 윤리와 사상 강사<br />
							    現) 국립통일교육원 학교통일교육강사<br />
							    現) 국립국어원 우리말꿈터 강사<br />
							    前) 정신여고, 양정고, 양천고, 신남중, 개웅중 교사
							</p>
						</div>
					</div>
				</div>
			...
			<img
				src="https://high.milkt.co.kr/UploadFile/LecturerCurriculum/f01337fb-5f45-4d79-b10d-be05e85ea84720230612121550.jpg"
				alt="" width="100%" />
						...
						<c:if test="${not empty sessionScope.user}">
							<c:forEach var="lecture" items="${lectures}">
								<form class="teacherLectureListContent" method="post"
									...
									<div>
										<img
											src="https://high.milkt.co.kr/UploadFile/LecturerImg/361_%EC%B0%A8%EB%AA%A9%EC%96%B8_Img10.png"
