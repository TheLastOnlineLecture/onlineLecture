		...
		<main>
			<div class="center">
				<div class="teacherDetailImg"  style="background-color: #FEF1E8">
					<div class="center">
						<img src="/public/teacher_eng/eng_ryun.jpg" alt="" />
						<div class="teacherInfo">
							...
							<p>
							    前) 이투스me 강사<br />
							    現) 강남구청 인터넷 수능방송 강사<br />
							    現) EBS 프리미엄 강사<br />
							    現) 운정연솔학원 원장<br />
							    現) 일산 우리학원 고등 최다 수강 강사
							</p>
						</div>
					</div>
				</div>
			...
			<img
				src="https://high.milkt.co.kr/UploadFile/LecturerCurriculum/fdf4cb55-b66d-489d-bb15-27ea2c30a4c720230612020717.jpg"
				alt="" width="100%" />
						...
						<c:if test="${not empty sessionScope.user}">
							<c:forEach var="lecture" items="${lectures}">
								<form class="teacherLectureListContent" method="post"
									...
									<div>
										<img
											src="https://high.milkt.co.kr/UploadFile/LecturerImg/356_%EA%B6%8C%EC%98%A4%EB%A5%9C_img10_0.png"
