    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                ...
                <h1>장바구니</h1>
                <!-- action 경로 수정 -->
                <form id="paymentForm" action="${pageContext.request.contextPath}/payments/user/payments.do"
                    method="post">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <c:forEach var="item" items="${cartItems}">
                                <tr>
                                    ...
                                    <td>
                                        <fmt:formatNumber value="${item.lecturePrice}" type="currency"
                                            currencySymbol="₩" />
                                    </td>
                                </tr>
                            </c:forEach>
                    ...
                    <div class="total">
                        ...
                        현재 잔액: <span id="mileage">₩<fmt:formatNumber value="${mileage}" type="number" /></span>
                ...
                <script>
                    ...
                    function calculateAfterMileage() {
                        ...
                        const mileage = parseInt(document.getElementById('mileage').textContent.replace(/[^\d]/g, ''));
                        const afterMileage = mileage - totalAmount;
