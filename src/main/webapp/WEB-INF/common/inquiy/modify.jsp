	...
	<div class="boxContainer">
		...
		<main>
			<div class="postWriteContainer">
				...
				<form action="/modifyQna.do" method="post" onsubmit="return validateForm()">
					<div class="formGroup">
					...
					<input type="text" id="postTitle" class="postInput" name="qnaTitle" value="${qnaDTO.qnaTitle}" oninput="updateCharCount('title')" placeholder="제목을 입력하세요" required>
					<span id="titleCharCount" class="charCount">0/30</span>
					</div>
					<div class="formGroup">
					<label for="postContent" class="postLabel">내용</label>
					<textarea id="postContent" name="qnaContent" class="postTextarea" placeholder="내용을 입력하세요" oninput="updateCharCount('content')" required>${qnaDTO.qnaContent}</textarea>
