...
<body>
	...
	<div class="boxContainer">
		...
		<main>
			<div class="center">
				<div class="teacherDetailImg" style="background-color:#F4EFEB">
					<div class="center">
						<img src="/public/teacher_science/science_jeong.jpg" alt="" />
						<div class="teacherInfo">
							<!-- 선생님 이름 동적으로 변경 -->
							<div class="teacherName">${teacherInfo.userName} 선생님</div>
							<p class="teacherProfile">약력</p>
							<p>
							    한국과학기술원(KAIST) 공학 석사 졸업<br />
							    現) 밀크T 과학 강사<br />
							    前) 국제 학회 연구 성과 발표<br />
							    前) 한국에너지학회 논문
							</p>
			...
			<img
				src="https://high.milkt.co.kr/UploadFile/LecturerCurriculum/e351b070-e1a0-4f1e-97c9-5f2893ac553120230612051916.jpg"
				alt="" width="100%" />
						...
						<c:if test="${not empty sessionScope.user}">
							<c:forEach var="lecture" items="${lectures}">
								<form class="teacherLectureListContent" method="post"
									...
									<div>
										<img
											src="https://high.milkt.co.kr/UploadFile/LecturerImg/Img10_295x335_2.png"
											alt="" class="teacherCircleImg" />
										<div class="textCenter">
											<span>과학</span> ${teacherInfo.userName}
										</div>
									</div>
