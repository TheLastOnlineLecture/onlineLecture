          ...
          <div class="teacherDetailImg">
            <div class="center">
              ...
              <div class="teacherInfo">
                <!-- 선생님 이름 동적으로 변경 -->
                <div class="teacherName">권순구 선생님</div>
                ...
                <div>
                  <p>
                    ...
                    고려대 교육심리학 박사<br />
                    現) 밀크T 중·고등 국어 강사<br />
                    前) 방과후 학교 국어 및 논술 강사<br />
                    (대진여고, 우정학사, 장수고, 상지여고, 계산여고,
                    보은고,형석고, 신남중)<br />
                    前) BC 코칭맘스쿨 국어 및 논술 학습법 강사
                  </p>
                </div>
        ...
        <div class="center">
          <div class="teacherLectureList">
            <div class="teacherDetailContainer">
              ...
              <form
                class="teacherLectureListContent"
                method="post"
                id="lectureForm"
              >
                <input type="hidden" name="lectureCode" value="강의 코드 값" />
                <input type="hidden" name="lectureTitle" value="강의 제목" />
                <input type="hidden" name="teacherName" value="권순구" />
                <div>
                  <img
                    src="https://high.milkt.co.kr/UploadFile/LecturerImg/2_%EA%B6%8C%EC%88%9C%EA%B5%AC_Img10_0.png"
                    alt=""
                    class="teacherCircleImg"
                  />
                  <div class="textCenter"><span>국어</span> 권순구</div>
                </div>
                <div class="teacherLectureArea">
                  <div class="di">
                    <div>
                      <div id="lectureCode">강의 코드</div>
                      <div>
                        <span class="best">BEST</span>
                        <a href="#"
                          ><span class="lectureTitleBold">강의 제목</span></a
                        >
                      </div>
                      <div><a href="#">강의 수강평</a></div>
                    </div>
                  </div>
                  <div>
                    <button
                      class="lecturePayBtn"
                      type="button"
                      onclick="submitForm('/lecture/user/insertCart.do')"
                    >
                      장바구니
                    </button>
                    <button
                      class="lecturePayBtn"
                      type="button"
                      onclick="submitForm('/payments/user/payments.do')"
                    >
                      구매하기
                    </button>
                    <div class="lecturePayValue">
                      <input type="checkbox" /><span>금액</span>
                    </div>
                  </div>
                </div>
              </form>
