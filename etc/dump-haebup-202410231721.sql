...
CREATE TABLE `STUDENT_LECTURE_PROGRESS` (
  `progress_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '수강 진행 ID',
...
CREATE TABLE `TBL_LECTURE_DETAIL` (
  ...
  `lecture_detail_file_name` bigint NOT NULL COMMENT '강의 상세 파일 이름',
...
-- Dump completed on 2024-10-23 17:21:23

insert into `tbl_member_type` (`user_type`, `user_type_name`) values ('S01', '학생');
insert into `tbl_member_type` (`user_type`, `user_type_name`) values ('S02', '패스 구매 학생');

insert into `TBL_MEMBER_TYPE` (`user_type`, `user_type_name`) values ('T01', '국어 선생님');
insert into `TBL_MEMBER_TYPE` (`user_type`, `user_type_name`) values ('T02', '영어 선생님');
insert into `TBL_MEMBER_TYPE` (`user_type`, `user_type_name`) values ('T03', '수학 선생님');
insert into `TBL_MEMBER_TYPE` (`user_type`, `user_type_name`) values ('T04', '과학 선생님');
insert into `TBL_MEMBER_TYPE` (`user_type`, `user_type_name`) values ('T05', '사회 선생님');
insert into `TBL_MEMBER_TYPE` (`user_type`, `user_type_name`) values ('A', '관리자');